...
"""
The data is available from https://github.com/alpapado/food-101
"""


class Food101DataProvider:
    ...
    def __init__(self, save_path=None, train_batch_size=32, test_batch_size=200, valid_size=None, n_worker=32,
        ...
        norm_mean = [0.5577418229651726, 0.44237353364447063, 0.3271720331774582]
        norm_std = [0.2591201131990323, 0.26311734416991267, 0.265891162964279]
