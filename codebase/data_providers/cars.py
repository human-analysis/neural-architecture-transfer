...
class StanfordCarsDataProvider(DataProvider):
    ...
    def save_path(self):
        if self._save_path is None:
            self._save_path = '/mnt/datastore/StanfordCars'  # home server
    ...
    def normalize(self):
        return transforms.Normalize(
            mean=[0.4105214534294453, 0.38574356611082533, 0.3959628699849632],
            std=[0.28611458811352136, 0.2801378084154138, 0.28520087594365295])
    ...
    def build_train_transform(self, image_size=None, print_log=True, auto_augment='rand-m9-mstd0.5'):
        ...
        aa_params = dict(
            ...
            img_mean=tuple([min(255, round(255 * x)) for x in [0.4105214534294453, 0.38574356611082533,
                                                               0.3959628699849632]]),
        )
